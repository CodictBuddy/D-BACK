...
let LocalStrategy = class LocalStrategy extends passport_1.PassportStrategy(passport_local_1.Strategy) {
    constructor(authService, sservice) {
        super({
    ...
    async validate(user_email, password) {
        try {
            ...
            throw new common_1.HttpException(response, code);
        }
    }
};
...
//# sourceMappingURL=local.statergy.js.map